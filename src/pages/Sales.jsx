...
export default function Sales() {
    ...
    return (
        <div className="pb-24 pt-4 space-y-6">
            <h1 className="text-2xl font-bold text-brand-dark dark:text-brand-white">Sales Dashboard</h1>

            {/* Key Metrics */}
            <div className="grid grid-cols-2 gap-4">
                <GlassCard className="p-4 flex flex-col items-center justify-center border-brand-gold/20">
                    <p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider mb-1">Total Revenue</p>
                    <h2 className="text-2xl font-bold text-custom-gold">₹{stats.totalRevenue.toLocaleString()}</h2>
                </GlassCard>
                <GlassCard className="p-4 flex flex-col items-center justify-center border-black/5 dark:border-white/10">
                    <p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider mb-1">Weekly Revenue</p>
                    <h2 className="text-xl font-bold text-brand-peach">₹{stats.weeklyRevenue.toLocaleString()}</h2>
                </GlassCard>
                <GlassCard className="p-4 flex flex-col items-center justify-center border-black/5 dark:border-white/10">
                    <p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider mb-1">Total Orders</p>
                    <h2 className="text-xl font-bold text-brand-dark dark:text-brand-white">{stats.totalSales}</h2>
                </GlassCard>
                <GlassCard className="p-4 flex flex-col items-center justify-center border-black/5 dark:border-white/10">
                    <p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider mb-1">Avg. Order</p>
