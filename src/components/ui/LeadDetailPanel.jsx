...
export default function LeadDetailPanel({ account, contacts, onClose, onRefreshAccounts }) {
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-full max-w-md bg-brand-dark/95 backdrop-blur-xl border-l border-white/10 shadow-2xl z-50 flex flex-col animate-in slide-in-from-right duration-300">
            {/* Header Sticky */}
