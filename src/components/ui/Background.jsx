    ...
    return (
        <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-[#0a0a0c] dark:bg-[#0a0a0c]">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-brand-gold/10 rounded-full mix-blend-screen filter blur-[100px] opacity-20 animate-blob" />
                ...
                <div className="absolute bottom-[-20%] left-[20%] w-[500px] h-[500px] bg-brand-gold/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob animation-delay-4000" />
